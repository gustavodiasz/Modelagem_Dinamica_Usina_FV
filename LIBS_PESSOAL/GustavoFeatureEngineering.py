...
class FeatureEngineering:
    def Reindexa_AjustaOFusoHorario_AddColunaZenith_ZeraPeGaNoite(self, st_entrada, lat=-9.398611, lon=-40.50, angulo=88, angulo_painel = 15, fuso_horario='America/Recife'):
        """
        Converte o índice para Datetime;
        ajusta o fuso para 'America/Recife';
        faz reamostragem (reindex) para frequência de 1 minuto;
        adiciona Coluna Zenith (Ângulo Zênite Solar aparente);
        zera G e P quando Zenith>88.
    	"""
        st = st_entrada.set_index('Time')
